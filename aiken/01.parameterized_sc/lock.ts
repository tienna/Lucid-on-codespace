...
const param = Data.to(new Constr(0, [utf8ToHex("Unlokc for me")]));
...
const tx = await lucid
    .newTx()
    .payToContract(scriptAddress, { Inline: param }, { lovelace: 2800000n })
    .commit();
  ...
  console.log(`Locked 2800000n lovelace to script Tx ID: ${txHash}`);
