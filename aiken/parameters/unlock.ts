...
const redeemer = Data.to(datum,DatumSchema);
...
const parameterizedScript = applyParamsToScript([redeemer],validator.script,);
...
const utxo = utxos.find(u => u.assets.lovelace === 3_600_000n);
console.log(utxos);
