...
console.log(`Mã CBOR của SC là: ${validator.script}`);
...
const tx = await lucid
      ...
      .attachScript(parameterized_script.script)  //lay the script
      .payToContract(scriptAddress, Data.void(),{ lovelace:5000000n, [unit]: 1n }) //chuyen den dia chi script
      .commit();
